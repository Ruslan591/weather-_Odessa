...
const vc  = pT != null ? gradientColor(P_STOPS, pT) : "#aaa";
    ...
    const trendPaths = {
        // 0: рост→падение, итог ВЫШЕ — пик в середине, конец выше старта
        "0":"M0,9 L12,6 L24,3 L36,5 L48,4",
        // 1: рост→плато, итог ВЫШЕ — растёт, потом горизонталь
        "1":"M0,10 L16,5 L32,3 L48,3",
        // 2: непрерывный рост
        "2":"M0,11 L12,8 L24,5 L36,3 L48,1",
        // 3: падение или плато→рост, итог ВЫШЕ — V-образный, конец выше старта
        "3":"M0,8 L16,11 L32,9 L48,3",
        // 4: без изменений — горизонталь
        "4":"M0,6 L12,6 L24,6 L36,6 L48,6",
        // 5: падение→рост, итог НИЖЕ — V-образный, конец ниже старта
        "5":"M0,4 L16,9 L32,7 L48,10",
        // 6: падение→плато, итог НИЖЕ — падает, потом горизонталь
        "6":"M0,2 L16,7 L32,10 L48,10",
        // 7: непрерывное падение
        "7":"M0,1 L12,4 L24,7 L36,9 L48,11",
        // 8: рост или плато→падение, итог НИЖЕ — Λ-образный, конец ниже старта
        "8":"M0,7 L16,4 L32,5 L48,10"
    };
