...
function buildDangerStops(greenMax, redMin){
    // greenMax — комфортно до этой высоты; redMin — опасно от этой высоты
    const deepRed = Math.min(WAVE_ARC_MAX, redMin * 2.2);
    return [
        {offset: 0,                          color:"#55efc4"}, // штиль/комфорт
        {offset: greenMax / WAVE_ARC_MAX,     color:"#ffd166"}, // граница комфорта
        {offset: redMin   / WAVE_ARC_MAX,     color:"#ff6b6b"}, // купание опасно
        {offset: deepRed  / WAVE_ARC_MAX,     color:"#d63031"}, // купание исключено
...
const WAVE_DANGER_STOPS     = buildDangerStops(0.50, 0.90);
...
const WINDWAVE_DANGER_STOPS = buildDangerStops(0.50, 0.80);
...
const SWELL_DANGER_STOPS    = buildDangerStops(0.30, 0.60);
