...
# Николаев/Крым/Констанцу, как в интерфейсе на скринах, а не маленький
# квадрат анализа вокруг Одессы.
BBOX = (25.0, 43.5, 37.5, 50.5)
WIDTH, HEIGHT = 900, 504  # соотношение сторон подогнано под BBOX (12.5°x7°)
