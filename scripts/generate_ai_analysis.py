...
def build_prompt(days, marine=None, data_time=None, verification_text=None):
    ...
    lines = [
        ...
        "## 🔬 Параметры анализа",
        "Для каждого дня одной строкой — ключевые значения которые определили прогноз:",
        "CAPE, LI, CIN, Z500, ω700, дефицит T-Td 700 гПа, T850, давление, нулевая изотерма.",
        "Формат: 'СЕГОДНЯ: CAPE=1174 Дж/кг, LI=-4.2, Z500=5787 м, T850=+18°C, ω700=-0.15 Па/с'",
